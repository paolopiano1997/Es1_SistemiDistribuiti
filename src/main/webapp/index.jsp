...
<%
	...
	if ( operation != null && operation.equals("insertCustomer") ) {
		...
		if(par==null) {
			producer = producerDAO.findProducerByName(null);
		}
		else{
			producer = producerDAO.findProducerById(Integer.parseInt(par));
		}
...
<div>
	...
	<table>
		<tr><th>Name</th><th>ProductNumber</th><th>Price</th><th>Producer</th></tr>
...
<div>
	<li <%= request.getRequestURI().contains("home") ? "style=\"background-color: #aaa;\"" : ""%>>
		<a href="<%= request.getContextPath() %>/home.jsp">Vai alla Home di acquisto</a>
	</li>
